...
#include <iostream>// it is used for input output functions in the code. inheritable
#include <stdlib.h>//is a header of the general purpose standard library of C language includes functions involoving memory allocation, process control, conversions and others.
#include <string>// used to add the functions of the string. 
#include <cctype>//used to classify the characters.
#include <cmath>//used to include the different functions of the maths in our code.
#include <cstdio>//used for input, output and some other functions. cannot inherit
#include <fstream>//used to work with files for read and write function.
#include <iomanip>//used for the formatting of the output.
#define max 10//it is a macro which is like a constant value we give to the processor before compiling the code
              // and wherever we write the max in our code it will automatically be replaced by the 10.
